                    ...
                    <div class="row gy-4 d-flex justify-content-end">
                        <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="info-item d-flex">
                                ...
                                <div>
                                    <h4>Dirección:</h4>
                                    <p>Progreso No° 31, Puebla, Pue 72210 </p>
                                </div>
                            </div><!-- End Info Item -->
                            ...
                            <div class="info-item d-flex">
                                ...
                                <div>
                                    <h4>Email:</h4>
                                    <p>pabloreyesjuarez77@outlook.com</p>
                                </div>
                            </div><!-- End Info Item -->
                        ...
                        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
                            <form class="php-email-form" name="contact" method="post" autocomplete="off">
                                <div class="row">
                                ...
                                <div class="form-group mt-3">
                                    <input type="text" class="form-control" name="subject" id="subject" placeholder="Ingrese asunto" required>
                                </div>
                                <div class="form-group mt-3">
                                ...
                                <div class="text-center"><button type="submit" name="submit" class="btn btn-primary">Enviar</button></div>
                            </form>
