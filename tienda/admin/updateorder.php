        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr height="50">
            <td colspan="2" class="fontkink2" style="padding-left:0px;">
              <div class="fontpink2"> <b>Actualizar estado de pedido !</b></div>
            </td>

          </tr>
          <tr height="30">
            <td class="fontkink1"><b>No Orden:</b></td>
          ...
          if ($st == $currrentSt) { ?>
            ...
            <tr height="50">
              ...
              <td class="fontkink"><span class="fontkink1">
                  <select name="status" class="fontkink" required="required">
                    ...
                    <option value="En camini">En camino</option>
            ...
            <tr styles=''>
              ...
              <td class="fontkink" aling="justify"><span class="fontkink">
            ...
            <tr>
              ...
              <td class="fontkink"> <input type="submit" name="submit2" value="Actualizar" size="40" style="cursor: pointer;" /> &nbsp;&nbsp;
                <input name="Submit2" type="submit" class="txtbox4" value="Cerrar Ventana " onClick="return f2();" style="cursor: pointer;" />
              </td>
            </tr>
          <?php } ?>
        </table>
