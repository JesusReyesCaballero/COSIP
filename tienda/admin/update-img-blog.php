        ...
        if ($_FILES["productimage1"]["error"] > 0) {
            ...
            if (in_array($_FILES["image"]["type"], $formats)) {
                ...
                if (!file_exists($image)) {
                    ...
                    if ($resultado) {
                        chmod($image, 0766);
                        $sql = mysqli_query($con, "update blog set image='$img' where id='$pid' ");
                        $_SESSION['msg'] = "Producto creado exitosamente !!";
                    }
                } else {
                    echo "La imagen insgresada ya existe";
                }
            } else {
...
?>
    ...
    <head>
        ...
        <title>Admin| Actualizar imagen de noticia</title>
                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                <div class="module-head">
                                    <h3>Actualizar imagen de noticia</h3>
                                </div>
                                <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
                                        ...
                                        $query = mysqli_query($con, "select title, image from blog where id='$pid'");
                                        $cnt = 1;
                                        ...
                                        ?>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="productName" readonly value="<?php echo htmlentities($row['title']); ?>" class="span8 tip" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <img src="blog_images/<?php echo htmlentities($pid); ?>/<?php echo htmlentities($row['image']); ?>" width="250" height="100">
                                                </div>
                                            </div>

                                            <div class="control-group">
                                                <label class="control-label" for="basicinput">Nueva image</label>
                                                <div class="controls">
