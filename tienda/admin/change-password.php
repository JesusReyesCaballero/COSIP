...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($num > 0) {
			...
			$_SESSION['msg'] = "Contraseña actualiza exitosamente !!";
		} else {
			$_SESSION['msg'] = "Contraseña actual incorrecta !!";
		}
	}
?>
	<!DOCTYPE html>
		...
		<script type="text/javascript">
			function valid() {
				if (document.chngpwd.password.value == "") {
					alert("Vacio!, por favor ingrese su acontraseña acutal !!");
					document.chngpwd.password.focus();
					return false;
				} else if (document.chngpwd.newpassword.value == "") {
					alert("Vacio! por favor ingrese su nueva contraseña !!");
					document.chngpwd.newpassword.focus();
					return false;
				} else if (document.chngpwd.confirmpassword.value == "") {
					alert("Vacio! por favor repita su contraseña !!");
