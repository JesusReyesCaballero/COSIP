								...
								<table class="table">
									...
									<tbody>
										...
										?>
												...
												<tr>
													<td class="col-md-2"><img src="admin/product_images/<?php echo htmlentities($row['pid']); ?>/<?php echo htmlentities($row['pimage']); ?>" alt="<?php echo htmlentities($row['pname']); ?>" width="60" height="100"></td>
													<td class="col-md-6">
