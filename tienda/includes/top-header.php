		...
		<div class="header-top-inner">
			<div class="cnt-account">
				<ul class="list-unstyled">
					...
					<li><a href="../nosotros.html"><i class="icon fa fa-info"></i> Sobre Nosotros</a></li>
					<li><a href="../blog.php"><i class="icon fa fa-file"></i> Noticias</a></li>
					<li><a href="../contacto.php"><i class="icon fa fa-phone"></i> Contactanos</a></li>
				</ul>
			</div>
			<div class="cnt-block">
