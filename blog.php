                                ...
                                foreach ($stmt as $row) {
                                    ...
                                    <div class='col-lg-6'>
                                        <article class='d-flex flex-column'>
                                            ...
                                            <h2 class='title'>
                                                <a href='blog-details.php?ip=" . $row['id'] . "'>" . $row['title'] . "</a>
                                            </h2>
                    
                                            <div class='meta-top'>
                                                <ul>
                                                  <li class='d-flex align-items-center'><i class='bi bi-person'></i> <a href='#'>" . $row['autor'] . "</a></li>
                                                  <li class='d-flex align-items-center'><i class='bi bi-clock'></i> <a href='#'><time datetime='2022-01-01'>" . $row['published'] . "</time></a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class='read-more mt-auto align-self-end'>
                                                <a href='blog-details.php?id=" . $row['id'] . "'>Leer Mas <i class='bi bi-arrow-right'></i></a>
                                            </div>
                                        </article>
